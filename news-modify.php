            ...
            <div id="content">
               ...
               <?php include('include/dashboard-header.php');?>
                ...
                <div class="container-fluid">
                     ...
                     <tr>
                                            <td>1</td>
                                            <td>Update on the NSE RFQ Platform</td>
                                            <td>Update on the NSE RFQ Platform</td>
                                            <td>https://www.nseindia.com</td>
                                            
                                            <td>
                   
                    <a href="news-modify.php" onclick="return confirm('Do you want to delete');"><i class="fa fa-trash"></i>
                    </a>
                </td>
                                        </tr>
