                                ...
                                <div class="form-group row">
                                    <div class="col-sm-4 mb-3 mb-sm-0">
                                         <input type="text" class="form-control " id="from_date"
                                            placeholder="From Date" name="from_date" required="" onfocus="(this.type='date')" onblur="(this.type='text')">
                                    </div>
                                    <div class="col-sm-4">
                                         <input type="text" class="form-control " id="to_date"
                                            placeholder="To Date" name="to_date" required="" onfocus="(this.type='date')" onblur="(this.type='text')">
                                    </div>
                                    <div class="col-sm-4">
...
if (isset($_GET['from_date'])) {
    ...
    $from_date=date("d/m/yy",strtotime($fdate));
    $tdate=$_GET['to_date'];
    $to_date=date("d/m/yy",strtotime($tdate));
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                <table class="table table-bordered" id="tblCustomers" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
<?php
    $fetch = "select t1.*,t2.* from create_job t1, create_job_items t2 WHERE t1.invoice_id = t2.invoice_id AND (t1.job_date > '$from_date'  AND t1.job_date < '$to_date') ";
